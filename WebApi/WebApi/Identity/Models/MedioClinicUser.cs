...
namespace Business.Identity.Models
{
    ...
    public class KenticoUser : Kentico.Membership.User
    {
        ...
        /// <summary>
        /// Explicit default constructor due to the existence of <see cref="KenticoUser(UserInfo)"/>.
        /// </summary>
        public KenticoUser()
        {
        }
        ...
        /// <summary>
        /// Creates a <see cref="KenticoUser"/> object out of a <see cref="UserInfo"/> one.
        /// </summary>
        ...
        */
        ...
        public KenticoUser(UserInfo userInfo)

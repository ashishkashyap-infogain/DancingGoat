...
[assembly: RegisterDocumentType(Car.CLASS_NAME, typeof(Car))]

namespace CMS.DocumentEngine.Types.DancingGoatMvc
{
	/// <summary>
	/// Represents a content item of type Car.
	/// </summary>
	public partial class Car : SKUTreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "DancingGoatMvc.Car";


		/// <summary>
		/// The instance of the class that provides extended API for working with Car fields.
		/// </summary>
		private readonly CarFields mFields;
		...
		public int CarID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("CarID"), 0);
			}
			set
			{
		...
		public int ModelYear
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("ModelYear"), 0);
			}
			set
			{
		...
		/// <summary>
		/// Gets an object that provides extended API for working with Car fields.
		/// </summary>
		[RegisterProperty]
		public CarFields Fields
		{
			get
			{
				return mFields;
		...
		/// <summary>
		/// Provides extended API for working with Car fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class CarFields : AbstractHierarchicalObject<CarFields>
		{
			/// <summary>
			/// The content item of type Car that is a target of the extended API.
			/// </summary>
			private readonly Car mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="CarFields" /> class with the specified content item of type Car.
			/// </summary>
			/// <param name="instance">The content item of type Car that is a target of the extended API.</param>
			public CarFields(Car instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.CarID;
				}
				set
				{
					mInstance.CarID = value;
				}
			}
			...
			public int ModelYear
			{
				get
				{
					return mInstance.ModelYear;
				}
				set
				{
					mInstance.ModelYear = value;
				}
			}
		}
		...
		{
		    /// <summary>
			/// The content item of type <see cref="Car" /> that is a target of the extended API.
			/// </summary>
			private readonly Car mInstance;
			...
			/// <summary>
			/// Initializes a new instance of the <see cref="ProductFields" /> class with SKU related fields of type <see cref="Car" /> .
			/// </summary>
			/// <param name="instance">The content item of type Car that is a target of the extended API.</param>
			public ProductFields(Car instance)
			{
				mInstance = instance;
			}

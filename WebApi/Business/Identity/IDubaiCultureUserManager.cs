...
{
    /// <summary>
    /// Wrapper around the <see cref="DubaiCultureUserStore"/> and its <see cref="Kentico.Membership.UserStore"/> main component for DI purposes.
    /// </summary>
    /// <typeparam name="TUser">The type of the user object.</typeparam>
    /// <typeparam name="TKey">The unique key.</typeparam>
    public interface IDubaiCultureUserManager<TUser, TKey> : IDisposable

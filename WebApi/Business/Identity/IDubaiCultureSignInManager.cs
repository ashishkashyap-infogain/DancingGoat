...
{
    /// <summary>
    /// Wrapper around the <see cref="DubaiCultureSignInManager"/> and its <see cref="Microsoft.AspNet.Identity.Owin.SignInManager{TUser, TKey}"/> base class for DI purposes.
    /// </summary>
    /// <typeparam name="TUser">The type of the user object.</typeparam>
    /// <typeparam name="TKey">The unique key.</typeparam>
    public interface IDubaiCultureSignInManager<TUser, TKey> : IDisposable
        ...
        where TKey: IEquatable<TKey>
    {
        ...
        /// </summary>
        IDubaiCultureUserManager<TUser, TKey> UserManager { get; set; }
